...
//   if (window.pageYOffset >= sticky && window.pageYOffset >= 200) {
...
// function myFunc2() {
//   let left__sidebar__text = document.querySelector('.left__sidebar__text')
//   if(window.pageYOffset >= 2693) {
//     left__sidebar__text.style.display = 'none'
//   } else if (window.pageYOffset < 2693) {
//     left__sidebar__text.style.display = 'block'
//   }
// }
// myFunc2()
